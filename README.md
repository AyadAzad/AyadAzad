...
<!-- telegram starts -->
<button style="font-family: inherit; font-size: 20px; background: royalblue; color: white; padding: 0.7em 1em; padding-left: 0.9em; display: flex; align-items: center; border: none; border-radius: 16px; overflow: hidden; transition: all 0.2s;">
  <div class="svg-wrapper-1" style="display: inline-block; width: 1em; height: 1em; margin-right: 0.3em;">
    <div class="svg-wrapper" style="display: block; transform-origin: center center; transition: transform 0.3s ease-in-out;">
      <svg height="24" width="24" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" style="display: block;">
